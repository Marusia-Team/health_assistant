...
class State:
    ...
    def __init__(self, id, text, transitions, default_transition, tts, is_end=False):
        self.id = id
        self.text = text
...
def init():
    ...
    State("100", "Привет! Я помогу Вам поддержать себя в хорошей форме, "
          ...
          [Transition("900", ["нет", "не хочу", "хватит"])], "101", "Слоныыыыыыыыы").register()
    ...
    State("101", "Скажите «Программа» для запуска тренировочной программы,"
          ...
          [Transition("900", ["нет", "не хочу", "хватит"])], "102", "Слоныыыыыыыыы").register()
    ...
    State("200", "Какой рацион выберите: для похудения или для набора массы?",
          [Transition("900", ["нет", "не хочу", "хватит"]),
           ...
           Transition("202", ["набор"])], "800", "Слоныыыыыыыыы").register()
    ...
    State("300", "Я расскажу Вам пять упражнений, каждое упражнение занимает "
          ...
          [Transition("900", ["нет", "не хочу", "хватит"]),
           ...
           Transition("301", ["Начать"])], "800", "Слоныыыыыыыыы").register()

    State("301", "", [], "800", "Слоныыыыыыыыы").register()

    # Упражнение
    State("400", "", [], "800", "Слоныыыыыыыыы").register()

    # Считаю баранов
    State("500", "Считаю баранов!\n"
                 "Раз\n Два\n Три\n Четыре\n Пять\n Шесть\n Семь\n Восемь\n Девять\n Десять\n "
                 "Спокойной ночи", [Transition("900", ["нет", "не хочу", "хватит"])], "102", "Слоныыыыыыыыы").register()
    ...
    # ситуативный unknown
    State("800", "", [], "900", "Слоныыыыыыыыы").register()

    # хватит
    State("900", "Буду рада видеть Вас снова!", [], None, "конец",  is_end=True).register()
