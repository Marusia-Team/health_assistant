...
def init():
    ...
    State("101",
          ...
          "«Активность» для запуска утренней активности\n\n"
    ...
    # Утренняя активность
    State("420", ["Доброе утро! Вас ждёт замечательный день! А чтобы он прошёл ещё лучше, нужно его хорошо начать",
                  "Я предложу вам упражнение, чтобы размяться после сна, "
                  "а после упражнения, рецепт вкусного завтрака. \nПриступим?"],
          [
              Transition("421", ["да"]),
              Transition("101", ["нет"])
          ], "800",
          "Доброе утро! Вас ждёт замечательный день! А чтобы он прошёл ^ещё^ лучше, нужно его хорошо начать.\n "
          "Я предложу вам ^упражнение^, чтобы размяться после сна, а после упражнения, рецепт вкусного ^завтрака^. "
          "\n\nПриступим?",
          buttons=[
              {
                  "title": "Да",
    ...
    State("421",
          "",
          [Transition("101", ["нет", "не хочу"]),
           Transition("422", ["да", "начать", "готов"]),
           Transition("421", ["другое"])
           ], "800", "",
          [
              {
                  "title": "Да",
    ...
    State("422",
          ["Начинаем!", "Хотите рецепт? Скажите «Дальше» чтобы перейти к рецепту, «Нет» чтобы выйти в меню"],
          [
              Transition("101", ["нет", "не хочу"]),
              Transition("423", ["дальше"])
          ],
          "800",
          "^Начинаем!^ \n <speaker audio_vk_id=2000512031_456239035> "
          "Хотите рецепт? Скажите ^«Дальше»^ чтобы перейти к рецепту, ^«Нет»^ чтобы выйти в меню",
          [
              {
                  "title": "Дальше",
                  "payload": {
          ...
          commands=[
              {
                  ...
                  "tts": "Тут то, что произносит Маруся",
                  "voice": "maria-serious"
              },
              {
                  "type": "Link",
                  "url": "http://d205bpvrqc9yn1.cloudfront.net/0859.gif",
                  "title": "Тренировка",
                  "text": "Передите по ссылке, чтобы посмотреть выполнение упражнения",
                  "image_id": 457239019
              }
          ]
          # card={
